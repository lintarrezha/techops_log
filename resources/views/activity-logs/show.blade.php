    ...
    <div class="max-w-2xl space-y-4">
        ...
        <div class="flex items-start justify-between gap-4 mb-4">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                ...
                {{-- Tombol Download --}}
                <a href="{{ route('activity.export.pdf', $activityLog) }}"
                    class="flex items-center gap-1.5 border border-gray-200 hover:border-red-300 hover:text-red-600 text-gray-500 text-xs font-medium px-3 py-1.5 rounded-lg transition">
                ...
                <a href="{{ route('activity.export.word', $activityLog) }}"
                    class="flex items-center gap-1.5 border border-gray-200 hover:border-blue-300 hover:text-blue-600 text-gray-500 text-xs font-medium px-3 py-1.5 rounded-lg transition">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path
                            d="M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" />
                    </svg>
