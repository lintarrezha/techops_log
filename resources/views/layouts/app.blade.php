        ...
        <aside class="w-56 bg-gray-900 flex flex-col flex-shrink-0">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                ...
                @if (auth()->user()->isAdmin())
                    <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider px-2 mt-4 mb-2">Admin</p>

                    <a href="{{ route('admin.activity-types.index') }}"
                        class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition{{ request()->routeIs('admin.*') ? 'bg-emerald-500/20 text-emerald-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
